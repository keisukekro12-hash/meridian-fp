...
1点目は、PM職が自分のやりたいこととの合致度が非常に高かったからです。前職でエンジニアとして5年間従事する中で、他部門との連携の部分や会社の仕組み・バックエンドの部分など、改善すべき点がたくさんあると感じており、そういったところに関われる仕事に強い興味を持っていました。設計職のキャリアアップとは別の選択肢として、経営企画やプロジェクト企画といった企画職も検討していた中で、PMという職があることを知り、これまでの技術経験も活かせて自分のやりたいこととのマッチ度が非常に高いと感じ、強く惹かれました。
...
2点目は、御社の社風への共感です。実情を伺った際に、会社のチャレンジ精神や状況に応じた臨機応変な柔軟さ、また個人が高い責任感を持って動く文化に、強く魅力を感じました。高いモチベーションを持って成長していける環境だと確信し、ぜひ御社で挑戦させていただきたいと思っております。`,
    },
    {
      ...
      variant: 'new',
      badge: 'new',
      script: `設計職として業務を続ける中で、お客様との仕様確認の場面やチームの進捗管理を任せていただいた際に、「人・スケジュール・要求を整理して、プロジェクト全体を動かしていく仕事」が自分には向いていると、強く感じるようになりました。

設計者の強みは、エンジニア目線で仕様や工数の現実感を正確につかめることだと思っています。PMとして社内のエンジニアと連携する際に、現場を知っている人間として信頼してもらえる立場——それが私の目指すべき姿だと考えました。

「設計もわかるPM」として技術面でも頼られる存在になりたい。そういう思いから、PM職へのキャリアチェンジを決意いたしました。`,
    },
    {
      id: 'F05',
      num: 'F05',
...
新卒から5年間、機械設計を専門とする会社に在籍し、東京エレクトロン様の設計部門に常駐する形で、半導体製造装置の機械設計業務に従事してまいりました。部品図・組立図の作成から変更設計・仕様確認まで幅広く担当し、3年目からは後輩のOJTを、4年目からはチームリーダーとして3名の進捗管理と育成も任せていただきました。

また、派遣という立場から客先の部長様より直接、請負への移管をご依頼いただき、5年間を通じて一貫して同じ部署の仕事を任せていただいたことは、私にとって最も誇りに思う実績です。

業務を通じてお客様との仕様調整や部門間の連携に携わる中で、プロジェクト全体をマネジメントする仕事に強い関心を持つようになり、このたびPM職へのキャリアチェンジを志望しております。どうぞよろしくお願いいたします。`,
      },
      {
        id: '02',
        num: '02',
