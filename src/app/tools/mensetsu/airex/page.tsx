...
前職はエンジニアの派遣・請負事業を行う会社で、
新卒から約3年間、
東北の東京エレクトロンテクノロジーソリューション様の
メカ設計部門に派遣として常駐し、
半導体製造装置の設計業務に従事しており、
3D CADを使ったモデリング・製図・解析・
数値計算などをメインに行なっていました。
...
【1点目】キャリアの幅を広げたいという思いです。
設計職として5年間、
技術的なスキルを積み上げてきましたが、
業務をする中で、設計部門だけでなく
前後の工程や他部門・部門間の連携の部分にも
自然と目が向くようになりました。
「もっとこうすればいいのに」と感じる機会が多々あり、
そういった改善に直接関われる仕事への興味が
どんどん強くなっていきました。

【2点目】モチベーション・責任感・成長意欲を持ちながら
スキルアップを図れる環境で
キャリアアップに繋げていきたい、という思いです。

27歳という、キャリアチェンジが現実的な
このタイミングで、転職を決断いたしました。`,
    },
    {
      id: 'F03',
      num: 'F03',
...
前職でエンジニアとして5年間従事する中で、
他部門との連携や会社の仕組みなど
改善すべき点が多々あると感じており、
そういったところに関われる仕事に
強い興味を持っていました。

経営企画・プロジェクト企画といった企画職も
検討していた中でPMという職を知り、
技術経験を活かせて、かつ
前後工程も含めた広い範囲での改善・効率化を
裁量を持って行える点に強く惹かれました。
...
高いモチベーションで成長していける環境だと確信し、
ぜひ御社で挑戦させていただきたいと思っております。`,
    },
    {
      id: 'F04',
      num: 'F04',
      ...
      variant: 'new',
      badge: 'new',
      script: `もともとは設計職でのキャリアアップを考えておりました。
また、27歳でのキャリアチェンジは
タイミング的に最後のチャンスかもしれないという意識もあり、
選択肢を幅広く考えておりました。
...
歯がゆさを感じておりました。
そういった部分を担えるような
幅の広い仕事に、強い魅力を感じておりました。

技術職でのやりがいも感じながら検討していた中で、
御社の担当者様とお話しする機会をいただき、
プロジェクトマネジメントという職種について
知ることができました。
技術経験も活かせて、かつ
歯がゆさを感じていた部分にも関われるということに
強く魅力を感じ、応募に至りました。`,
    },
    {
      id: 'F05',
...
「この変更に合わせてここも改善すると
　より効果的です」という
プラスアルファの提案を積極的に行ってまいりました。

【2点目】「スピード」の継続的な改善です。
同じ業務であれば、1回目に1時間かかった作業を
2回目は50分・3回目は40分という形で、
常に効率化を意識して取り組んでまいりました。

3年目には後輩のOJT、
4年目からはチームリーダーとして
3名の進捗管理・育成も担い、
技術とマネジメントの両方を積み上げることができました。`,
    },
    {
      id: 'F06',
      num: 'F06',
      ...
      badge: 'new',
      script: `【Q1 — 業務理解の深掘り】
「PM職として、入社後まず最初にアサインされるのは
　どのような案件規模・フェーズが多いでしょうか？」
...
設計業務を通じてお客様との仕様調整や
部門間の連携に関わる中で、
プロジェクト全体を動かす仕事への関心が高まり、
このたびPM職へのキャリアチェンジを志望しております。
...
本日はどうぞよろしくお願いいたします。`,
      },
      {
        ...
        script: `私の強みは、
「技術的な理解力」と
「関係者をつなぐコミュニケーション力」の2点です。

前職では設計者として5年間、
お客様の要求仕様を正確に理解した上で
設計に落とし込む業務を繰り返してきました。
お客様が求めていることを的確につかみ、
それを社内に噛み砕いて伝えることが、
設計の質と信頼を守る上で最も大切だと
身をもって学んでまいりました。

また、チームリーダーとして3名の進捗管理を担う中で、
「誰が何をどこまでやっているか」を常に把握し、
遅延の予兆を早めに察知して動く習慣が身につきました。

PM職では、この
「技術がわかった上でのコミュニケーション力」と
「先を読んだスケジュール管理」を
最大限に発揮できると確信しております。`,
      },
      {
...
常にスキルアップや業務の効率化・改善を意識しており、
「昨日より今日、今日より明日」という気持ちで
仕事に取り組んでまいりました。

前職でも、周囲の社員と比較して
自分が経験年数に見合ったスキルを身につけられているか、
それ以上の価値を発揮できているかを
常に自分自身で評価しながら業務に臨んでおりました。`,
      },
      {
        id: '04',
        num: '04',
        ...
        time: '30秒前後',
        script: `私の短所は、
細部にこだわりすぎてしまう完璧主義な部分です。

精度が求められる場面では強みになる一方、
スピードが求められる局面では
マイナスに働くこともあると認識しております。

そのため、仕事に取り掛かる前に
「いつまでに・何を・何を参照して」の3点を
必ず整理してから着手するようにしており、
一定の精度を維持しつつ納期を守ることを
意識して取り組んでおります。`,
      },
...
精度や網羅性を重視する性格から、
抜け漏れやリスクがないかを徹底的に確認し、
完璧な状態を作り上げることに強みを発揮できるタイプです。
「前を向いて引っ張る」よりも
「後ろをしっかりカバーする」役割が得意だと感じております。

ただ、前線で活躍したい・
自分が中心になって動きたいという思いも強く持っていますので、
完全なサポート役というよりは
ナンバーツーとして組織を支えながら
存在感を出していくポジションが
最も自分らしいと考えています。`,
    ...
    cards: [
      {
        ...
        time: '1〜2分',
        badge: 'new',
        script: `前職では、半導体製造装置メーカーである
東京エレクトロン様の機械設計部門に、
派遣で3年間、請負で2年間、
計5年間お世話になりました。

業務のメインは、SolidWorksを使った
3Dモデリングおよび製図です。
設計変更・新規設計問わず、
部品図から組立図まで幅広く担当しておりました。

解析面では、SolidWorksを用いた
構造解析（静的解析）をメインに、
必要に応じて熱解析・流体解析も担当しておりました。
また、装置内の部品干渉の計算や、
手計算が必要な数値計算なども行っておりました。
...
技術とマネジメントの両方を積み上げることができました。`,
      },
      {
        ...
        time: '30〜40秒',
        badge: 'new',
        script: `4年目、請負に移行したタイミングから、
3名のメンバーのチームリーダーを務めておりました。

主な業務は、
週次での進捗確認・リソースの調整・
成果物のレビュー・逐一の業務フォローです。

特に意識していたのは、
課せられた設計納期に対して
タイム管理がしっかり行われているかどうかという点と、
検討すべき内容に漏れや不備がないかという点でした。

検討内容の漏れについては、
本人では判断が難しい部分も多いため、
自身の知見でカバーできる範囲はフォローし、
行き届かない部分については、
お客様の有識者やベテラン社員に
コネクトする役割を担うことで、
成果物の質を担保できるよう
マネジメントを心がけておりました。`,
      },
      {
        ...
        title: 'トラブルの対応方法',
        time: '30〜40秒',
        script: `トラブルが発生した際は、まず
状況の全体像と詳細をしっかり把握することを最初に行います。

その上で原因を明確にし、
対処に何が必要か・
他の工程や部品への影響はないかを整理してから
リカバリー処置に入るようにしております。

また、早急な対応が必要な場面や
専門的な知識が求められる局面では、
関連部署の方や有識者に積極的に知見を仰ぎながら、
求められるスピードを守りつつ
精度を落とさない対応を心がけてまいりました。`,
      },
      {
        id: '08b',
        num: '08b',
        title: '他部署との連携方法',
        time: '30〜40秒',
        script: `前職ではメカ設計の担当として、
制御や筐体・周辺装置を担う各部署と
連携しながら設計をフィックスしてまいりました。

専門知識が必要な場面では
各カテゴリーの担当者に積極的に知見を仰ぎ、
製造部門とは現場で作業される方の
意見・要望をヒアリングして設計に反映させることも
行っておりました。

試作品の現場確認を経て設計完了に持っていくプロセスを
繰り返す中で、要所要所で各部署と
密に連携する習慣が身についたと感じております。

PMとしても、この経験をもとに
関係部署を巻き込みながら
プロジェクトを動かしていけると考えております。`,
      },
    ],
  },
  {
...
【1点目】自分のキャリアの幅を広げたいという思いです。
設計職として5年間、
技術的なスキルを着実に積み上げてきました。
ただ業務をこなす中で、設計部門だけでなく、
前後の工程や他部門が担う仕事・
部門間の連携の部分にも
自然と目が向くようになっていきました。
「もっとこうすればいいのに」と感じる機会が多々あり、
そういった改善に直接干渉できる立場への興味が
どんどん強くなっていきました。
...
前職でエンジニアとして5年間従事する中で、
他部門との連携や会社の仕組み・バックエンドなど、
改善すべき点がたくさんあると感じており、
そういったところに関われる仕事への関心がありました。

設計職のキャリアアップとは別の選択肢として、
経営企画やプロジェクト企画といった企画職も
候補として考えておりました。
その中でPMという職があることを知り、
これまでの技術経験も活かせて、
自分のやりたいこととのマッチ度が非常に高いと感じ、
強く惹かれました。
...
ぜひ御社で挑戦させていただきたいと思っております。`,
      },
      {
        ...
        script: `現在は、
設計職としてのキャリアアップを図る軸と、
キャリアチェンジを図る軸の2軸で活動しております。

設計系の企業と反響営業職の企業を各1〜2社ずつ、
「ここであれば活躍・成長できる」と感じた会社に絞って
選考を進めており、
反響営業の会社からは内定をいただいている状況です。

志望順位としては、
これまでの技術経験を活かしながら
プロジェクト全体に携わるPM職である御社が
第一志望です。`,
      },
    ],
  },
    ...
    cards: [
      {
        ...
        time: '1〜1分20秒',
        script: `前職で、一時期、
上司との関係構築に苦労した時期がありました。
コミュニケーションが取りにくく、
メンタル面でも負荷がかかる状況でしたが、
この経験から大切なことを学びました。

まず、「この経験を乗り越えれば今後の耐性になる」と
ポジティブに捉え直すようにしました。
また、上司も多くの仕事と責任を抱えており、
その分のストレスがあることを理解し、
歩み寄る姿勢を心がけました。

具体的には、
仕事を積極的に引き受けて負荷を分散させることや、
協力的な姿勢・コミットする面を見せることで、
少しずつ関係性を改善していきました。
...
自社エンジニアへの橋渡し、
スケジュール管理まで、
PMとしての基礎をしっかり習得することを
最優先に考えております。

その上で、医療機器分野の専門知識を深め、
お客様から
「この案件はあなたに任せたい」と言っていただけるような、
信頼されるPMを目指したいと考えております。

将来的には、
複数案件を並走して動かせる力をつけながら、
チームや後進の育成にも
関わっていきたいと思っております。`,
      },
      {
