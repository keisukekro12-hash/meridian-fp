...
2021年度に愛知工業大学を卒業後、株式会社テクノプロに入社いたしました。前職はエンジニアの派遣・請負事業を行っている会社で、新卒から約3年間、東北の東京エレクトロンテクノロジーソリューション様のメカ設計部門に派遣として常駐し、半導体製造装置の設計業務に従事しておりました。

その後、神奈川への異動の際に客先の部長様より直接、請負として仕事をそのまま持っていってほしいとご依頼いただき、合わせて一貫して5年間、設計業務を担わせていただきました。
...
その後、神奈川への異動の際に、客先の部長様より直接、請負として仕事をそのまま持っていってほしいとご依頼いただき、合わせて一貫して5年間、設計業務を担わせていただきました。
