...
1点目は、私のキャリア背景とPM職の内容が強く重なっている点です。前職ではTEL様の設計部門に5年間常駐し、お客様の要求仕様を理解しながら設計を行い、3名のチームリーダーとして進捗管理も担ってきました。御社のPM職で求められる「受注から引渡しまでの全工程管理・社内設計部門との仕様調整・スケジュール管理」は、私がこれまで経験してきた業務と本質的に重なります。設計者の気持ちが分かるPMとして、即戦力に近い形で貢献できると確信しております。

2点目は、アイソレーターという製品が持つ社会的意義への共感です。ワクチン・抗がん剤・再生医療製品など、人の命に直結する製品の製造に欠かせない無菌空間を作る仕事であり、国内トップシェアを誇るその技術力に強く惹かれました。規模は大きくなくとも、社会に不可欠な役割を担っている点に非常に魅力を感じております。

3点目は、御社の成長性と組織の風土です。1年半先まで受注が埋まっているほどの需要があり、再生医療分野の拡大とともに今後もさらなる成長が見込める環境で、自分も共に成長していきたいと考えております。`,
    },
    {
      id: 'F04',
      num: 'F04',
...
1点目は、キャリアの幅を広げたいという思いです。設計職として5年間技術的なスキルを積む中で、設計部門だけでなく前後の工程や他部門との連携部分にも常に目を向けてきました。「もっとこうすればいいのに」と感じる機会が多々ある中で、そういった改善に直接関われる立場への興味が強くなっていきました。

2点目は、より個人がモチベーションや責任感・成長意欲を持って働ける環境に身を置きたいという思いです。

27歳という、キャリアチェンジが現実的なこのタイミングで転職を決断いたしました。`,
      },
      {
        id: '10',
        num: '10',
...
1点目は、PM職が自分のやりたいこととの合致度が非常に高かったからです。前職で5年間エンジニアとして従事する中で、他部門との連携や会社の仕組みなど改善すべき点が多くあると感じており、そういった部分に関われる仕事として経営企画・プロジェクト企画などの企画職も検討しておりました。その中でPMという職を知り、これまでの技術経験も活かしながら自分のやりたいことを実現できると強く感じ、志望いたしました。

2点目は、御社の社風への魅力です。実情を伺った際に、会社のチャレンジ精神や状況に応じた柔軟な対応力、また個人が高い責任感を持って働く環境に強く惹かれました。高いモチベーションを持ちながら成長できる場だと確信し、ぜひ御社で挑戦したいと考えております。`,
      },
      {
        id: '11',
        num: '11',
